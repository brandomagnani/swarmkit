# SwarmKit SDK Reference

## Installation
```bash
pip install swarmkit fastapi uvicorn python-dotenv
```
...
1. **Always use async/await** - SwarmKit is async-first
2. **Use context manager** - `async with SwarmKit(...) as agent:` handles cleanup
